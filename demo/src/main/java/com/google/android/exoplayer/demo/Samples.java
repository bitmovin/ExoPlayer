...
/* package */ class Samples {
  ...
  public static final Sample[] bitmovin_DASH = new Sample[] {
	new Sample("Sintel (DASH) generated by bitcodin", "uid:dash:sintel",
    	"http://bitcdn-vix1.bitmovin.net:8080/content/sintel/exoplayer.mpd",
